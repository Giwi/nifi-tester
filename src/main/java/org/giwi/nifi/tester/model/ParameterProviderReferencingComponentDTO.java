 ...
 */
@JsonPropertyOrder({
  ParameterProviderReferencingComponentDTO.JSON_PROPERTY_ID,
  ParameterProviderReferencingComponentDTO.JSON_PROPERTY_NAME
})
...
public class ParameterProviderReferencingComponentDTO {
  ...
  public ParameterProviderReferencingComponentDTO() {
  }

  public ParameterProviderReferencingComponentDTO id(@javax.annotation.Nullable String id) {
  ...
  public ParameterProviderReferencingComponentDTO name(@javax.annotation.Nullable String name) {
