 ...
 */
@JsonPropertyOrder({
  FlowAnalysisRuleStatusDTO.JSON_PROPERTY_ACTIVE_THREAD_COUNT,
  FlowAnalysisRuleStatusDTO.JSON_PROPERTY_RUN_STATUS,
  FlowAnalysisRuleStatusDTO.JSON_PROPERTY_VALIDATION_STATUS
})
...
public class FlowAnalysisRuleStatusDTO {
  ...
  public FlowAnalysisRuleStatusDTO activeThreadCount(@javax.annotation.Nullable Integer activeThreadCount) {
