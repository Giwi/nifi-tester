 ...
 */
@JsonPropertyOrder({
  ParameterContextReferenceDTO.JSON_PROPERTY_ID,
  ParameterContextReferenceDTO.JSON_PROPERTY_NAME
})
...
public class ParameterContextReferenceDTO {
  ...
  public ParameterContextReferenceDTO() {
  }

  public ParameterContextReferenceDTO id(@javax.annotation.Nullable String id) {
  ...
  public ParameterContextReferenceDTO name(@javax.annotation.Nullable String name) {
