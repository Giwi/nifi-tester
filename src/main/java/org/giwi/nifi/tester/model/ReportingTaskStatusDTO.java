 ...
 */
@JsonPropertyOrder({
  ReportingTaskStatusDTO.JSON_PROPERTY_ACTIVE_THREAD_COUNT,
  ReportingTaskStatusDTO.JSON_PROPERTY_RUN_STATUS,
  ReportingTaskStatusDTO.JSON_PROPERTY_VALIDATION_STATUS
})
...
public class ReportingTaskStatusDTO {
  ...
  public ReportingTaskStatusDTO activeThreadCount(@javax.annotation.Nullable Integer activeThreadCount) {
