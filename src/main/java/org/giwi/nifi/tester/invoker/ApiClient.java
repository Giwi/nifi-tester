...
import org.giwi.nifi.tester.invoker.auth.Authentication;
import org.giwi.nifi.tester.invoker.auth.HttpBearerAuth;
import org.giwi.nifi.tester.invoker.auth.ApiKeyAuth;
...
public class ApiClient extends JavaTimeFormatter {
    ...
    protected String basePath = "https://localhost:8443/nifi-api";
    ...
    protected void init() {
        ...
        authentications.put("CookieSecureAuthorizationBearer", new ApiKeyAuth("cookie", "__Secure-Authorization-Bearer"));
        authentications.put("HTTPBearerJWT", new HttpBearerAuth("Bearer"));
            ...
            var factory = new org.springframework.http.client.SimpleClientHttpRequestFactory() {
                ...
                protected void prepareConnection(java.net.HttpURLConnection connection, String httpMethod) throws java.io.IOException {
                    if (connection instanceof javax.net.ssl.HttpsURLConnection) {
                        ((javax.net.ssl.HttpsURLConnection) connection).setSSLSocketFactory(sf);
