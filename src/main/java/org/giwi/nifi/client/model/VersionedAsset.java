 ...
 */
@JsonPropertyOrder({
  VersionedAsset.JSON_PROPERTY_IDENTIFIER,
  VersionedAsset.JSON_PROPERTY_NAME
})
...
public class VersionedAsset {
  ...
  public VersionedAsset identifier(@javax.annotation.Nullable String identifier) {
  ...
  public VersionedAsset name(@javax.annotation.Nullable String name) {
