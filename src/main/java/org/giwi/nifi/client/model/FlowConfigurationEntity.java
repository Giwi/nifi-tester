...
import org.giwi.nifi.client.model.FlowConfigurationDTO;
 ...
 */
@JsonPropertyOrder({
  FlowConfigurationEntity.JSON_PROPERTY_FLOW_CONFIGURATION
})
...
public class FlowConfigurationEntity {
  public static final String JSON_PROPERTY_FLOW_CONFIGURATION = "flowConfiguration";
  @javax.annotation.Nullable
  private FlowConfigurationDTO flowConfiguration;

  public FlowConfigurationEntity() {
  }

  public FlowConfigurationEntity flowConfiguration(@javax.annotation.Nullable FlowConfigurationDTO flowConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_FLOW_CONFIGURATION)
  ...
  @JsonProperty(JSON_PROPERTY_FLOW_CONFIGURATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFlowConfiguration(@javax.annotation.Nullable FlowConfigurationDTO flowConfiguration) {
    this.flowConfiguration = flowConfiguration;
  }
